...
const pertanyaanList = [
  {
    id: 1,
    pertanyaan:
      "Bagaimana tingkat pemahaman pegawai terhadap visi dan misi organisasi?",
    jenisPertanyaan: "Pilihan Ganda",
  },
  {
    id: 2,
    pertanyaan: "Apakah organisasi memiliki program pengembangan kompetensi?",
    jenisPertanyaan: "Pilihan Ganda",
  },
  {
    id: 3,
    pertanyaan: "Seberapa sering dilakukan evaluasi kinerja pegawai?",
    jenisPertanyaan: "Pilihan Ganda",
  },
  {
    id: 4,
    pertanyaan: "Apakah tersedia platform knowledge management?",
    jenisPertanyaan: "Pilihan Ganda",
  },
];
                  ...
                  <tr key={item.id} className="hover:bg-blue-50">
                    ...
                    <td className="py-2 px-4 border-b">
                      <Button
                        variant="outline"
                        size="sm"
                        className="mr-1 border-blue-500 text-blue-600 hover:bg-blue-50 hover:border-blue-600 focus:ring-2 focus:ring-blue-200"
                        type="button"
                        onClick={() => alert("Tambah data")}
                        aria-label="Tambah"
                      >
